...
const calculateFidelityWrtPhiPlus = (rho: DensityMatrix): number => {
  const term00 = rho.get(0, 0)?.re ?? 0;
  const term03 = rho.get(0, 3)?.re ?? 0;
  const term30 = rho.get(3, 0)?.re ?? 0;
  const term33 = rho.get(3, 3)?.re ?? 0;
  return 0.5 * (term00 + term03 + term30 + term33);
};

describe('mathUtils', () => {
  describe('matrix operations', () => {
    const matrixA = new DensityMatrix([
      [new ComplexNum(1, 1), new ComplexNum(2, 0)],
      [new ComplexNum(0, 3), new ComplexNum(4, -1)]
    ]);
    const matrixB = new DensityMatrix([
    ...
    const expectedProduct = new DensityMatrix([
      [new ComplexNum(3, 7), new ComplexNum(3, 11)],
      [new ComplexNum(-3, 20), new ComplexNum(12, 27)]
    ]);

    const matrixC = new DensityMatrix([[new ComplexNum(1, 0), new ComplexNum(2, 0)], [new ComplexNum(3, 0), new ComplexNum(4, 0)]]);
    const matrixD = new DensityMatrix([[new ComplexNum(0, 0), new ComplexNum(5, 0)], [new ComplexNum(6, 0), new ComplexNum(7, 0)]]);
    // C ⊗ D
    const expectedTensor = new DensityMatrix([
    ...
    const matrixRho4x4 = new DensityMatrix([
  ...
  describe('basis transforms', () => {
    it('calculates Bell basis fidelity correctly for |Φ⁺⟩ state', () => {
      const phiPlusState = new DensityMatrix([
        [new ComplexNum(0.5, 0), new ComplexNum(0, 0), new ComplexNum(0, 0), new ComplexNum(0.5, 0)],
        [new ComplexNum(0, 0), new ComplexNum(0, 0), new ComplexNum(0, 0), new ComplexNum(0, 0)],
        [new ComplexNum(0, 0), new ComplexNum(0, 0), new ComplexNum(0, 0), new ComplexNum(0, 0)],
        [new ComplexNum(0.5, 0), new ComplexNum(0, 0), new ComplexNum(0, 0), new ComplexNum(0.5, 0)]
      ...
      const phiPlusBellBasisManual = new DensityMatrix([
    ...
    it('calculates Bell basis fidelity correctly for |Ψ⁻⟩ state', () => {
        const psiMinusState = new DensityMatrix([
          [new ComplexNum(0, 0), new ComplexNum(0, 0), new ComplexNum(0, 0), new ComplexNum(0, 0)],
        ...
        const psiMinusBellBasisManual = new DensityMatrix([
          [new ComplexNum(0, 0), new ComplexNum(0, 0), new ComplexNum(0, 0), new ComplexNum(0, 0)],
          [new ComplexNum(0, 0), new ComplexNum(0, 0), new ComplexNum(0, 0), new ComplexNum(0, 0)],
          [new ComplexNum(0, 0), new ComplexNum(0, 0), new ComplexNum(0, 0), new ComplexNum(0, 0)],
